                    ...
                    <div class="my-4">
                        <div class="plans_container d-flex justify-content-between">
                            ...
                            <a href="/special" class="nav-link">
                                <button class="btn rounded-pill plans_btn purp_border purp_text">Special</button>
                            </a>
                        ...
                        <div class="card primary_gradient p-3 mx-2 text-light">
                            <p class="fs-xsm">6 month</p>
                            <p class="fw-bold fs-5">N10,050</p>
                            <p class="fs-xsm">Save 25%</p>
                        </div>
                    </div>
                    <div class="col-12">
