                    ...
                    <div class="my-4">
                        <div class="plans_container d-flex justify-content-between">
                            <a href="/basic" class="nav-link">
                                <button class="btn rounded-pill plans_btn purp_border purp_text">Basic</button>
                            </a>
                            <a href="/popular" class="nav-link">
                                <button class="btn rounded-pill purp_border purp_text">Popular</button>
                            </a>
                            ...
                            <a href="/ultimate" class="nav-link">
                                <button class="btn rounded-pill purp_border purp_text">Ultimate</button>
                            </a>
                        </div>
                        <div class="card primary_gradient p-3 mx-2 text-light">
                            <p class="fs-xsm">1 month</p>
                            <p class="fw-bold fs-5">N5,046</p>
                            <p class="fs-xsm">Save 5%</p>
                        </div>
                    </div>
                    <div class="col-12">
